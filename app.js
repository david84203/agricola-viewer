...
function drawCrop(canvas, card) {
  ...
  const draw = (img) => {
    ...
    const isTTS = card.source_image.startsWith('FR') || card.source_image.startsWith('Gm') || card.source_image.startsWith('Go') || card.source_image.toLowerCase().startsWith('wa') || card.source_image.toLowerCase().startsWith('wm') || card.source_image.toLowerCase().startsWith('bi');
