...
const rawCards = [
  ...
  { id: "B077*", name: "土坑", type: "minor", cost: "1份小麥", pts: "1分", req: "3張職業卡", desc: "你每次使用「臨時工」行動格時，便額外獲得3塊磚頭。", deck: "B", bonus: "無", pass: "否", img: "014.jpg" },
  ...
  // 17.jpg
  { id: "B002*", name: "迷你圈地", type: "minor", cost: "2份小麥", pts: "無", req: "無", desc: "你立即將1個區域圈成圈地，不須支付木頭（若你已有圈地，該新圈地必須緊鄰既有的圈地）。在你打出此卡後，將其傳給你左手邊的玩家，加入他的手牌中。", deck: "B", bonus: "無", pass: "是", img: "017.jpg" },
  ...
  { id: "A005*", name: "磚頭倉庫", type: "minor", cost: "1份小麥", pts: "無", req: "無", desc: "你的個人供應區每有2塊磚頭，立即獲得1塊磚頭。在你打出此卡後，將其傳給你左手邊的玩家，加入他的手牌中。", deck: "A", bonus: "無", pass: "是", img: "017.jpg" },
  ...
  { id: "B013*", name: "木匠小屋", type: "minor", cost: "1根木頭1塊石頭", pts: "無", req: "無", desc: "你每擴建一個木造房間，只須支付2根木頭與2綑蘆葦。", deck: "B", bonus: "無", pass: "否", img: "017.jpg" },
