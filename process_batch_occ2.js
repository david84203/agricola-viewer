...
const mdContent = fs.readFileSync('C:/Users/bboylu/.gemini/antigravity/brain/1d079712-1065-43d9-86dd-dc8dc56f2b2d/E_Occ2_draft.md', 'utf8');
...
fs.writeFileSync('duplicates_occ2.json', JSON.stringify(duplicates, null, 2));
...
// Copy image
if (!fs.existsSync('images/舊版E職業2.jpg')) {
  fs.copyFileSync('E:/Users/bboylu/Desktop/農家樂中文化/舊版牌/舊版E職業2.jpg', 'images/舊版E職業2.jpg');
}
